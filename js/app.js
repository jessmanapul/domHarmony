...
var matCountUpdate = document.getElementById('matCount');
matCountUpdate.innerHTML = '11';

//2. In the nav element, target the span element with the id of 'msgCount' and change the number from 0 to 23.

var msgCountUpdate = document.getElementById('msgCount');
msgCountUpdate.innerHTML = '23';

//3. In the div id data section, target the div element with the id of 'fullname' and change Full Name to Ronald McDonald.

var realName = document.getElementById('fullname');
realName.innerHTML = 'Ronald McDonald';
...
prof.id = 'pro2';
prof.innerHTML = "I LIKE BIG MACS AND I CANNOT LIE! YOUR OLDER BROTHERS CAN'T DENY!";
profile.appendChild(prof);

//10. In the div id matches section, target the first div element with the class name of firstName and change Name to Wendy.

var soulMate = document.getElementsByClassName('firstName');
soulMate[0].innerHTML = 'Wendy';
